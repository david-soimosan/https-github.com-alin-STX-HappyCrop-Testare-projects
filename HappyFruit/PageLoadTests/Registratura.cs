...
namespace HappyFruit.PageLoadTests
{
    class Registratura
    {
        ...
        [Test]
        public void RegistraturaPage()
        {
            var href = driver.FindElement(By.XPath("/html/body/div[1]/aside/section/ul/li[11]/a")).GetAttribute("href");

            driver.Navigate().GoToUrl(href);

            var addNewUserButton = driver.FindElement(By.XPath("/html/body/div[1]/div/section/a"));

            Assert.That(addNewUserButton != null);
        }
